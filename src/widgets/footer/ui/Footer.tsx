  ...
  return (
    <footer className="bg-brand-950 text-white pt-16 pb-8 px-4 md:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            <img
              src="/logo.png"
              alt="Ээлеп кал"
              className="w-12 h-12 rounded-2xl shadow-xl shadow-black/20"
            />
          ...
          <div className="space-y-2">
            <p className="text-sm font-black text-white/90 uppercase tracking-tight leading-tight">
        ...
        {/* Service Column */}
        <div>
          <h3 className="font-black text-[10px] uppercase tracking-[0.2em] text-white/30 mb-8">
            Сервис
          </h3>
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
        <p className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em]">
          © 2025 Ээлеп кал. Сделано с{" "}
          <span className="text-rose-500 mx-1">❤️</span> в Кыргызстане
        </p>
