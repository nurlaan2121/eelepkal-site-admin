        ...
        >
            <div className="p-6 flex items-center justify-between">
                {(!isCollapsed || isMobileMenuOpen) && (
                    <span className="text-xl font-bold text-brand-primary whitespace-nowrap">Ээлеп кал</span>
                )}
                <button
            ...
            <nav className="flex-1 px-4 space-y-1 overflow-y-auto scrollbar-hide">
                {MENU_ITEMS.map((item) => (
                    ...
                    >
                        <item.icon className={cn("w-5 h-5", (isCollapsed && !isMobileMenuOpen) ? "mx-auto" : "mr-3 text-slate-400 group-hover:text-brand-primary transition-colors")} />
            ...
            <div className="p-4 border-t border-slate-50">
                ...
                >
                    ...
                    {(!isCollapsed || isMobileMenuOpen) && <span className="font-medium">Выйти</span>}
                </button>
            </div>
        </aside>
    );
