...
export const SuperAdminBookingsPage: React.FC = () => {
  ...
  const bookings: GlobalBooking[] = [
    {
      id: 1,
      customerName: "Азамат И.",
      customerPhone: "+996 700 11 22 33",
      venueName: "Bellagio",
      guestsCount: 4,
    ...
    {
      id: 2,
      customerName: "Светлана К.",
      customerPhone: "+996 555 44 55 66",
      venueName: "Faiza",
      guestsCount: 2,
      bookingDate: "2026-05-23",
      bookingTime: "18:30",
    ...
    {
      id: 3,
      customerName: "Искандер М.",
      customerPhone: "+996 777 88 99 00",
  ...
  return (
    <PageLayout
      ...
      description="Глобальный список резервов во всех заведениях системы"
      actions={
        <div className="flex flex-row sm:items-center gap-1 w-full sm:w-auto">
          <Button
            variant="ghost"
            className="flex-1 sm:flex-none gap-2 rounded-l-2xl rounded-r-none font-bold text-xs"
          >
            <Filter size={16} />
            Фильтры
          </Button>
          <Button
            variant="ghost"
            className="flex-1 sm:flex-none gap-2 rounded-r-2xl rounded-l-none font-bold text-xs"
          >
            <Calendar size={16} />
            Сегодня
          </Button>
    ...
    >
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-3 border-b border-gray-100 flex flex-col md:flex-row gap-4 items-center justify-between bg-gray-50/30">
          <Input
            size="md"
            variant="outline"
            icon={<Search size={18} />}
            ...
            <tbody className="divide-y divide-gray-100 font-medium">
              {bookings.map((booking) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-tight border ${
                        booking.status === "CONFIRMED"
