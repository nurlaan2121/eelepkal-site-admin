...
export const VenueInfoCard = ({
  ...
  return (
    <motion.div
      ...
      viewport={{once: true}}
      className={cn(
        "bg-white rounded-[24px] border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] relative overflow-hidden transition-all duration-300 p-4 sm:p-8",
        className,
      )}
    >
      <div className={cn(`relative`, noPadding ? "" : "")}>
        {(title || onEdit) && (
