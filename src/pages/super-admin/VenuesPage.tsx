                ...
                >
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between gap-3 mb-2">
                                <h3 className="font-black text-slate-900 text-lg leading-tight line-clamp-2 group-hover:text-brand-700 transition-colors">{venue.name}</h3>
                    ...
                    <div className="mt-4 ml-28 space-y-2.5">
                        ...
                        <div className="flex items-start gap-2.5 bg-gradient-to-r from-slate-50 to-transparent rounded-xl px-3.5 py-2.5 border border-slate-100">
                            ...
                            <span className="text-sm font-semibold text-slate-700 line-clamp-2 leading-relaxed">{venue.address}</span>
                        </div>
                        ...
                        <div className="flex items-center gap-2.5 px-1">
                            ...
                            <span className="text-xs font-medium text-slate-500">
                                Администратор: <span className="text-slate-800 font-black">{venue.adminFullName}</span>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                {isLoading ? (
                    Array.from({ length: 4 }).map((_, i) => (
                        <div key={i} className="p-5 border-b border-slate-100 animate-pulse">
