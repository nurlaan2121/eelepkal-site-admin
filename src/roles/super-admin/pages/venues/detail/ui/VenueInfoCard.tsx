...
export const VenueInfoCard: React.FC<VenueInfoCardProps> = ({
  ...
  return (
    <motion.div
      ...
      viewport={{once: true}}
      className={cn(
        "bg-white rounded-[24px] border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] relative overflow-hidden transition-all duration-300",
        className?.container,
      )}
    >
      <div className={cn(`relative`, noPadding ? "" : "p-6 sm:p-8")}>
        {(title || onEdit) && (
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3 text-lg font-black text-slate-900 tracking-tight">
