...
import {
  ...
  AdminVenueBasic,
  AdminVenueDetails,
  AdminVenueWorkingHours,
  AdminVenueAmenities,
  AdminVenueContacts,
  AdminVenuePublicAdmin,
  AdminVenueFeedback,
} from "@/api/admin/adminVenueService";
...
export const AdminMyVenuePage: React.FC = () => {
  ...
  const capacitiesList = Object.entries(detailsData.capacities) as [
    string,
    number,
  ][];
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="flex items-center gap-1.5 text-sm font-bold bg-white/20 backdrop-blur-md px-3 py-1.5 rounded-xl">
                <Wallet size={16} />≈ {basicDataSafe.averageCheck} сом
              </span>
              <span className="flex items-center gap-1.5 text-sm font-bold bg-white/20 backdrop-blur-md px-3 py-1.5 rounded-xl">
                <Clock size={16} />
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-black text-slate-900">
                {basicDataSafe.rating.toFixed(2)}
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="space-y-2">
            {formattedHours.map(({day, time, isDayOff}) => (
              ...
              >
                ...
                <span
                  className={`text-sm font-black ${isDayOff ? "text-red-500" : "text-slate-900"}`}
                >
                  {time}
                </span>
              </div>
