...
export const VenueHeroSection = ({
  ...
  return (
    <section className="relative w-full overflow-hidden rounded-2xl sm:rounded-[32px]">
      {/* Main Hero Image */}
      <div className="relative aspect-[4/3] sm:aspect-auto w-full group cursor-zoom-in overflow-hidden bg-slate-100">
        <AnimatePresence>
          <motion.img
            ...
            className="w-full h-[400px] object-cover group-hover:scale-105 transition-transform  duration-[2000ms]"
        ...
        {/* Bottom Overlay Info */}
        <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent p-6 md:p-10 flex items-end justify-between text-white">
          <div>
